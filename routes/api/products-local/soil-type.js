...
var ProductModel = mongoose.model("Soil"); //Model: Soil is reffered to SoilType, needs to be changed when BBDD will change. Same for collection in model.
var ProductName = "soilType";
var ProductCollection = "soils";
